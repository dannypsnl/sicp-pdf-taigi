...
\setmonofont{FreeMono}                                 %  to turn out curly
                                                       %  ("typographic")
...
\setmainfont{FreeSerif}                        %  the REPL without
\setsansfont{FreeSans} %-----------------------%  giving errors.
...
\newcommand{\acronym}[1]{\textsc{\fontspec[Numbers={OldStyle}]{FreeSerif}\MakeLowercase{#1}}}
\newcommand{\uppersc}[1]{{\fontspec[Letters=UppercaseSmallCaps]{FreeSerif}#1}}
